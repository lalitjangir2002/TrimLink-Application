...
const Navbar = () => {
  ...
  return (
    <div className="h-16 bg-white  z-50 flex items-center sticky top-0">
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
        <Link to="/">
          <h1 className="font-bold text-3xl italic sm:mt-0 mt-2">
            TrimLink
          </h1>
        </Link>
        <ul
        ...
        >
          <li className="hover:text-btnColor font-[500]  transition-all duration-150">
            <Link
              className={`${
                path === "/" ? "font-semibold" : "text-indigo-800"
              }`}
              to="/"
            >
              Home
          ...
          <li className="hover:text-btnColor font-[500]  transition-all duration-150">
            <Link
              className={`${
                path === "/about" ? " font-semibold" : "text-indigo-800"
              }`}
              to="/about"
            >
              About
          ...
          {token && (
            ...
            <Link
              className={`${
                path === "/dashboard" ? "font-semibold" : "text-indigo-800"
              }`}
              to="/dashboard"
            >
              Dashboard
